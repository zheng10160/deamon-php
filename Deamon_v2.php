...
require("./redis/RedisHandler.php");

require("./model/dacp.php");
/**
        ...
        while(true){
            try{
                ...
                if($data){
                    ...
                    $sql 		= "INSERT INTO ".$data['data_table']." (".$data['data_table'].".".$fieldsvals[0].") VALUES (".$fieldsvals[1].")";
